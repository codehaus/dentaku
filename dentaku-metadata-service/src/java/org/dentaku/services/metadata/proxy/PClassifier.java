...
public class PClassifier
     ...
     */
    public static Classifier newInstance(UMLStaticHelper scriptHelper,
                                         Classifier classifier) {
        Class[] interfaces = {
            UMLClassifier.class,
            Classifier.class
        };
        return (Classifier) java.lang.reflect.Proxy.newProxyInstance(classifier.getClass().getClassLoader(),
                interfaces,
                new PClassifier(classifier, scriptHelper));
    }

    protected PClassifier(Classifier classifier,
    ...
    public Collection getAttributes() {
        ...
        for (Iterator i = attributes.iterator(); i.hasNext();) {
            attributeProxies.add(PAttribute.newInstance(scriptHelper, (Attribute) i.next()));
        }
    ...
    public Collection getDependencies() {
        ...
        for (Iterator i = dependencies.iterator(); i.hasNext();) {
            dependencyProxies.add(PDependency.newInstance(scriptHelper, (Dependency) i.next()));
        }
    ...
    public Collection getOperations() {
        ...
        for (Iterator i = operations.iterator(); i.hasNext();) {
            Object proxy =
                    POperation.newInstance(scriptHelper,
                            (Operation) (i.next()));
