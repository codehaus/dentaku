...
public class PPackage
    ...
    public static UmlPackage newInstance(UMLStaticHelper scriptHelper,
        ...
        return (UmlPackage) java.lang.reflect.Proxy.newProxyInstance(umlPackage.getClass().getClassLoader(),
                interfaces,
                new PPackage(umlPackage, scriptHelper));
    }

    private PPackage(UmlPackage umlPackage,
