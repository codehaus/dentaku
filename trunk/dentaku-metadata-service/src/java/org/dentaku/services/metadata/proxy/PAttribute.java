...
public class PAttribute
     ...
     */
    public static Attribute newInstance(UMLStaticHelper scriptHelper,
                                        Attribute attribute) {
        ...
        return (Attribute) java.lang.reflect.Proxy.newProxyInstance(attribute.getClass().getClassLoader(),
                interfaces,
                new PAttribute(attribute, scriptHelper));
    }

    private PAttribute(Attribute attribute,
