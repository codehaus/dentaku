...
public class PModelElement
    ...
    public static ModelElement newInstance(UMLStaticHelper scriptHelper,
                                           ModelElement modelElement) {
        Class[] interfaces = {
            UMLClassifier.class,
            ModelElement.class
        };
        return (ModelElement) java.lang.reflect.Proxy.newProxyInstance(modelElement.getClass().getClassLoader(),
                interfaces,
                new PModelElement(modelElement, scriptHelper));
    }

    protected PModelElement(ModelElement modelElement,
    ...
    public Collection getTaggedValues() {
        ...
        for (Iterator i = taggedValues.iterator(); i.hasNext();) {
            ...
            taggedValueProxies.add(PTaggedValue.newInstance(scriptHelper, taggedValue));
        }
