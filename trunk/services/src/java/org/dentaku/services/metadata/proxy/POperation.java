...
public class POperation extends PModelElement implements UMLOperation {
     ...
     */
    public static Operation newInstance(UMLStaticHelper scriptHelper,
                                        Operation operation) {
        Class[] interfaces =
                new Class[]{UMLOperation.class, Operation.class};
        return (Operation) java.lang.reflect.Proxy.newProxyInstance(operation.getClass().getClassLoader(),
                interfaces,
